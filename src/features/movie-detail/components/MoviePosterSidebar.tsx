...
export function MoviePosterSidebar({
  movie,
  posterUrl,
  hasMissingBasicInfo,
  refreshing,
  onRefreshPoster,
}: MoviePosterSidebarProps) {
  return (
      ...
      {hasMissingBasicInfo && (
        <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 flex flex-col gap-3">
          ...
          <p className="text-xs text-amber-500/80">
            Some details like year, runtime, or rating are missing. Fetch from OMDb
            to update.
          </p>
          <button
